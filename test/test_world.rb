...
class TestWorld < Test::Unit::TestCase
  ...
  def test_world_get_cell_out_of_bounds
    ...
    assert_nil world.get_cell_xy(-1, -1)
    assert_nil world.get_cell_xy(0, -1)
    assert_nil world.get_cell_xy(-1, 0)
    assert_nil world.get_cell_xy(4, 4)
  end
  ...
  def test_world_still_life_block
    ...
    assert_equal true, world.get_cell_xy(0, 0).alive
    assert_equal true, world.get_cell_xy(0, 1).alive
    assert_equal true, world.get_cell_xy(1, 0).alive
    assert_equal true, world.get_cell_xy(1, 1).alive
  end
  ...
  def test_world_still_life_behive
    ...
    assert_equal true, world.get_cell_xy(0, 1).alive
    assert_equal true, world.get_cell_xy(0, 2).alive
    assert_equal true, world.get_cell_xy(1, 0).alive
    assert_equal true, world.get_cell_xy(1, 3).alive
    assert_equal true, world.get_cell_xy(2, 1).alive
    assert_equal true, world.get_cell_xy(2, 2).alive
  end
  ...
  def test_world_still_life_loaf
    ...
    assert_equal true, world.get_cell_xy(1, 3).alive
    assert_equal true, world.get_cell_xy(2, 1).alive
    assert_equal true, world.get_cell_xy(2, 3).alive
    assert_equal true, world.get_cell_xy(3, 2).alive
  end
  ...
  def test_world_oscillator_blinker
    ...
    assert_equal false, world.get_cell_xy(1, 0).alive
    assert_equal false, world.get_cell_xy(1, 2).alive
  ...
  def test_world_oscillator_toad_1
    ...
    assert_equal true, world.get_cell_xy(1, 0).alive
    assert_equal true, world.get_cell_xy(1, 3).alive
    assert_equal true, world.get_cell_xy(2, 0).alive
    assert_equal true, world.get_cell_xy(2, 3).alive
    assert_equal true, world.get_cell_xy(3, 1).alive
  end
  ...
  def test_world_oscillator_toad_2
    ...
    assert_equal true, world.get_cell_xy(1, 1).alive
    assert_equal true, world.get_cell_xy(1, 2).alive
    assert_equal true, world.get_cell_xy(1, 3).alive
    assert_equal true, world.get_cell_xy(2, 0).alive
    assert_equal true, world.get_cell_xy(2, 1).alive
    assert_equal true, world.get_cell_xy(2, 2).alive
  ...
  def test_world_oscillator_beacon
    ...
    assert_equal true, world.get_cell_xy(2, 3).alive
    assert_equal true, world.get_cell_xy(3, 2).alive
    assert_equal true, world.get_cell_xy(3, 3).alive
    assert_equal false, world.get_cell_xy(1, 1).alive
    assert_equal false, world.get_cell_xy(2, 2).alive
  end
end